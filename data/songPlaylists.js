var listSong = [
    ...
    [{
...

        {
            name: "Lạ Lùng",
            singer: ["Vũ"],
            path: "./assets/music/listSong5/song5.mp3",
            image: "./assets/img/music/listSong5/song5.jpg"
        },

        {
            name: "Phố Không Em",
            singer: ["Thái Đinh"],
            path: "./assets/music/listSong5/song6.mp3",
            image: "./assets/img/music/listSong5/song6.jpg"
        },
        {
            name: "Suýt Nữa Thì",
            singer: ["Andiez"],
            path: "./assets/music/listSong2/song7.mp8",
            image: "./assets/img/music/listSong2/song7.jpg"
        },
        {
            name: "3107",
            singer: ["Duongg"],
            path: "./assets/music/listSong2/song8.mp8",
        ...
        },
        {
            name: "BlackJack",
            singer: ["Soobin", "Binz"],
            path: "./assets/music/listSong2/song20.jpg",
