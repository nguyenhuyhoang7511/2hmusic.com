var listSpecialPlaylist = [{
        header: {
            explication: "Thần Tượng Của Bạn",
            topicName: "Trịnh Thắng Bình",
            image: "./assets/img/tabExplore/specialPlaylists/headerAvatars/playlistList1.jpg",
        },
        playlists: [{
                name: "Những Bài Hát Hay Nhất Của Trịnh Thăng Bình",
    ...
    {
        header: {
            explication: "Chương Trình Nổi Bật",
