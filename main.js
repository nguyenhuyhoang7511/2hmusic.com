                            ...
                            <div class="row__item item--event">
                                <div class="row__item-container flex--top-left">
                                    ...
                                    <div class="row__item-info media">
                                        <div class="media__left">
                                            <div class="media__info">
                                                <span class="info__title event--title is-active">Số Người</span>
                ...
                <div class="charts__container">
                    <div class="grid">
                        <div class="chart__container-header mb-40">
                            <h3 class="chart__header-name">#Top Trending</h3>
                        ...
                        <div class="charts__expand">
                            <button class="button charts__expand-btn">Xem thêm</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    handleEvents: function() {
        ...
        sidebarSubnavItems.forEach(subnavItem => {
            subnavItem.onclick = (e) => {
                showNotificationToast('Chức năng này đang trong quá trình cập nhật. Xin vui lòng thử lại sau!')
            }
        })
    ...
    loadCurrentPlaylist(playlistBtn, index) {
        if(playlistBtn) {
            if(index < 4) {
                ...
                showNotificationToast('Vui lòng thử lại sau');
            }
        }
    },
